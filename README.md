...
* Fruit counter (**requires [Spore UI Fixer Framework](https://github.com/Valla-Chan/Valla_SporeUIFixerFramework/releases) mod by [Valla-chan](https://github.com/Valla-chan)**);
...
* [Delta Unit](https://github.com/TheDeltaUnit): conributor, made a music "Branching Out" for flora editor and tested the mod;
